// ============================================
// GLOBAL DATA - Auto-generated by GFFI Bot
// ============================================
const countryData = [
  { flag: "🇺🇸", name: "USA", gffi: 51.5, status: "success" },
  { flag: "🇩🇪", name: "Germany", gffi: 52.7, status: "success" },
  { flag: "🇫🇷", name: "France", gffi: 52.4, status: "success" },
  { flag: "🇯🇵", name: "Japan", gffi: 54.0, status: "success" },
  { flag: "🇬🇧", name: "UK", gffi: 52.1, status: "success" },
  { flag: "🇨🇳", name: "China", gffi: 51.4, status: "success" },
  { flag: "🇮🇳", name: "India", gffi: 52.1, status: "success" },
  { flag: "🇧🇷", name: "Brazil", gffi: 52.8, status: "success" },
  { flag: "🇿🇦", name: "S. Africa", gffi: 56.0, status: "success" },
  { flag: "🇨🇦", name: "Canada", gffi: 51.8, status: "success" },
  { flag: "🇮🇹", name: "Italy", gffi: 52.9, status: "success" },
  { flag: "🇦🇺", name: "Australia", gffi: 52.0, status: "success" },
  { flag: "🇰🇷", name: "S. Korea", gffi: 60.0, status: "warning" },
  { flag: "🇸🇬", name: "Singapore", gffi: 52.2, status: "success" },
  { flag: "🇲🇽", name: "Mexico", gffi: 52.7, status: "success" },
  { flag: "🇦🇷", name: "Argentina", gffi: 54.7, status: "success" }
];

const globalGFFI = 53.2;
const updateDate = '15 Mar 2026';
const updateTime = '02:01 PM';
  ...
  let html = `
    ...
    <div class="india-card gffi-card">
      ...
      <div class="card-content">
        ...
        <span class="card-value">${indiaData?.gffi || 'N/A'}</span>
        <span class="card-status status-${indiaData?.status || 'warning'}">${indiaData?.status === 'success' ? '🟢 SUCCESS' : '🟡 WATCH'}</span>
      </div>
    </div>
  `;
  container.innerHTML = html;
...
function renderCountryTable() {
  ...
  countryData.forEach(c => {
    let statusClass = c.status === 'success' ? 'status-success' : c.status === 'warning' ? 'status-warning' : 'status-alert';
    let riskLevel = c.gffi >= 70 ? '🔴 HIGH' : c.gffi >= 65 ? '🟠 ALERT' : c.gffi >= 58 ? '🟡 WATCH' : '🟢 LOW';
...
function renderIndiaTable() {
  ...
  html += `<tr>
    ...
    <td class="gffi-value">${indiaData?.gffi || 'N/A'}</td>
    <td>-</td>
    <td><span class="status-${indiaData?.status || 'warning'}">${(indiaData?.status || 'WARNING').toUpperCase()}</span></td>
  </tr>`;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Set global values
  const globalGffiEl = document.getElementById('global-gffi');
  if (globalGffiEl) globalGffiEl.textContent = globalGFFI;
  
  const updateTimeEl = document.getElementById('update-time');
  if (updateTimeEl) updateTimeEl.textContent = updateDate;
  
  const updateTimeHmEl = document.getElementById('update-time-hm');
  if (updateTimeHmEl) updateTimeHmEl.textContent = updateTime;
